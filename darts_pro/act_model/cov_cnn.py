...
class LinelessLayer(nn.Module):
    ...
    def __init__(self,input_num,output_num,shutcut_num=0,hidden_size=16,device=None,layer_norm=True,batch_norm=False,
        ...
        self.bn_redu = nn.BatchNorm1d(hidden_size,track_running_stats=track_running_stats)       
    ...
    def forward(self, input_data,redu=False,res_data=None): 
        ...
        if redu:
            ...
            input_data = self.bn_redu(input_data) 
            input_data = self.relu_redu(input_data)            
