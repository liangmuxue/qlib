...
class _TFTCusModule(_TFTModule):
    ...
    def compute_loss(self,output,target):
        return self.criterion(output.squeeze(dim=-1), target,epoch=self.current_epoch)
    ...
    def validation_step(self, val_batch, batch_idx) -> torch.Tensor:
        ...
        self.val_metric_show(output,target)
    ...
    def val_metric_show(self,output,target):
        for s_index in range(3):
            ...
            target_title = "val_metric_{}".format(s_index)
            names = ["output","target"]
