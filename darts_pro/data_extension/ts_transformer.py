...
class TSTransformerEncoderClassiregressor(nn.Module):
    ...
    def __init__(self, feat_dim, num_classes=5, max_len=30, d_model=64, n_heads=8, num_layers=3, dim_feedforward=256,
                 dropout=0.1, pos_encoding='fixed', activation='gelu', norm='BatchNorm', freeze=False,device=None):
    ...
    def forward(self, X):
        ...
        padding_masks = torch.ones([X.shape[0],X.shape[1]]).to(self.device)
