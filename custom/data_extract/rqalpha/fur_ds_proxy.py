...
class FurDataProxy(DataProxy):
    ...
    def get_bar(self, order_book_id: str, dt: date, frequency: str = '1d') -> BarObject:
        ...
        bar = self._data_source.get_bar(instrument.order_book_id, dt, frequency)
        if bar:
    ...
    def get_last_price(self, order_book_id):
        # type: (str) -> float
        dt = self._price_board._env.calendar_dt
        last_price = self._data_source._get_prev_close(order_book_id,dt,"1m")
        return last_price
