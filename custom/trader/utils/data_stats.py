...
# 记录项：date--日期，instrument--品种代码，pred_trend--预测趋势，prev_close--预测前收盘价，
...
if __name__ == "__main__":
    stats = DataStats(work_dir="custom/data/results/stats")  
    # stats.check_step_output()
    # stats.combine_real_result()
